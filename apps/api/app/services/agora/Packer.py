# -*- coding: utf-8 -*-
# Vendored verbatim from Agora's official Packer (dependency of AccessToken2).
# Source: https://raw.githubusercontent.com/AgoraIO/Tools/master/DynamicKey/AgoraDynamicKey/python3/src/Packer.py
# Downloaded: 2026-07-13. Pure stdlib (struct) — no deps.
