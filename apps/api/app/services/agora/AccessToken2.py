# -*- coding: utf-8 -*-
# Vendored verbatim from Agora's official AccessToken2 builder.
# Source: https://raw.githubusercontent.com/AgoraIO/Tools/master/DynamicKey/AgoraDynamicKey/python3/src/AccessToken2.py
# Downloaded: 2026-07-13. Pure stdlib (hmac/hashlib/zlib/struct/base64) — no deps.
