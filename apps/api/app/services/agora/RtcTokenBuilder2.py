# -*- coding: utf-8 -*-
# Vendored verbatim from Agora's official RtcTokenBuilder2.
# Source: https://raw.githubusercontent.com/AgoraIO/Tools/master/DynamicKey/AgoraDynamicKey/python3/src/RtcTokenBuilder2.py
# Downloaded: 2026-07-13. The one edit vs. upstream: the AccessToken2 import is
# package-relative (`from .AccessToken2`) so this imports as
# app.services.agora.RtcTokenBuilder2.
